...
function registrarFuncoes(){
    ...
    botao.onmouseover = definirParagrafo; // criar o vinculo com o botao e a função, chamar a função a ser executada, ela vai manipular a ação do botao que so acontecera quandoo botao fr acionado
